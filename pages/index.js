  ...
  return (
    ...
    <script src="js/bootstrap.min.js"></script>
          ...
          <div className="carousel">
            <div>
              <div className="full-slider position-relative">
                ...
                <div className="p-5 slider-bG" >
                  <div className="card-sliders" style ={{backgroundImage: 'url(images/homemarketings.jpg)'}}>
            ...
            <div>
              <div className="full-slider position-relative">
                <div className="overlay"></div>
                <div className="p-5 slider-bG" >
                  <div className="card-sliders" style={{backgroundImage: 'url(images/business-mans.jpg)'}} >
      ...
      <section className="apply-section">
        <div className="bg-looking common-spaces w-100 parallax" >
          <div className="container">
            <div className="row align-items-center" style= {{backgroundImage: 'url(images/looking-photo.jpg)'}}>
              <div className="col-md-4">
